...
describe Ecutools::J2534 do
  include_context 'J2534' do
    context 'PassThruConnect' do
      ...
      it 'returns ERR_PROTOCOL_ID_NOT_SUPPORTED when passed an unsupported protocol' do
        things.test_with_ecutuned {
          ...
          expect {
            j2534.PassThruConnect(1, 0, Ecutools::J2534::CAN_ID_BOTH, 500000, resource, 1)
          }.to raise_error Ecutools::J2534Error, /ERR_PROTOCOL_ID_NOT_SUPPORTED/
        }
      end
